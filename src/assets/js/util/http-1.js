...
<param>serviceId{=}${serviceId}{,}dataPackType{=}1{,}userName{=}dep{,}password{=}1{,}compress{=}N{,}encrypt{=}N</param>
<data><![CDATA[<?xml version="1.0" encoding="UTF-8"?><WSD><MESSAGE><VERSION>1</VERSION></MESSAGE><DATA>
<BEAN>${op}\n</BEAN>
</DATA></WSD>]]></data></ser:service></soapenv:Body></soapenv:Envelope>`
}
//转译中文字符
  ...
  return new Promise(function(reslove, reject) {
    xmlreader.read(data, function(error, response) {
      if (error) {
        ...
        var res = response['soap:Envelope']['soap:Body']['ns2:serviceResponse']['return'].text()
...
Vue.prototype.ajax = function(opts) {
  ...
  _params = opts.serverId ? t.getWebserviceParams(opts.serverId, _params) : _params
  if (_method == 'get') {
    info.params = _params
  } else {
