...
require_once "hzzyy/libhzzyy/WxPay.Api.php";
require_once "hzzyy/WxPay.JsApiPay.php";
...
if($mobilesave=="success"){
	...
	$input->SetNotify_url('http://www.hnwisdom.com/BMFW/dist/public/weixin/wxpay/example/notify_bmfw_HuiZhou_hzzyy.php');
