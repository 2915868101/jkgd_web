...
require_once "hzzyy/libdyrmyy/WxPay.Api.php";
require_once 'hzzyy/libdyrmyy/WxPay.Notify.php';
		...
		try{
			...
			if($arr["LX"]=="0"){//移动端挂号
				...
				<DATA>
					...
					<STARTTIME>".$arr["ZDMC"]."</STARTTIME>
					<ENDTIME>".$arr["ZSMC"]."</ENDTIME>
					<REGFEE>".$arr["PID"]."</REGFEE>
					<TREATFEE>".$arr["ZSID"]."</TREATFEE>
					<ISTIMEREG>".$arr["XMID"]."</ISTIMEREG>
